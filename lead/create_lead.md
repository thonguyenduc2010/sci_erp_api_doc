...
*  **URL Params**
   ...
   /{domain}/api/v1/lead
    ...
    | crm_line_ids | True | Mảng | [ <br/> { <br/> 'service_id': id, <br/> 'quantity': Int, <br/> 'source_extend_id': id, <br/> }, <br/> ] <br/> * service_id: Sản phẩm *quantity: Số lượng * source_extend_id: Nguồn mở rộng  | Danh sách sản phẩm |
