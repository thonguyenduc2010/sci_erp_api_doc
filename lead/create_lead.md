...
*  **BODY Params**
   ...
   /{domain}/api/v1/lead
    ...
    | crm_line_ids | True | Mảng | [ <br/> { <br/> 'product_id': id, <br/> 'quantity': Int, <br/> 'source_extend_id': id, <br/> }, <br/> ] <br/> - product_id: Sản phẩm <br/>- quantity: Số lượng <br/>- source_extend_id: Nguồn mở rộng  | Danh sách sản phẩm |
