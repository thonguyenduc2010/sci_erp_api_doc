...
*  BODY
   ...
   /{domain}/api/v1/lead/{id}
    ...
    | crm_line_ids | True | Mảng | [ <br/> { <br/> 'product_id': Int, <br/> 'quantity': Int, <br/> 'source_extend_id': Int, <br/> }, <br/> ] <br/> - product_id: Sản phẩm <br/>- quantity: Số lượng <br/>- source_extend_id: Nguồn mở rộng  | Danh sách sản phẩm |
